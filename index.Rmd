...
```{r Animal-survival-rate, fig.width = 10, fig.height = 8, fig.cap="Animal survival rate", fig.align= "center"}
...
```{r Australia-Euthanization-count, fig.width = 10, fig.height = 8, fig.cap="Australia Euthanization rate", fig.align= "center"}
options(scipen=999)
 p2 <- ggplot(q2,
...
```{r Complaints-against-who-Cats-or-Dogs,fig.width = 8, fig.height = 8, fig.cap="Complaints against who Cats or Dogs", fig.align= "center"}
