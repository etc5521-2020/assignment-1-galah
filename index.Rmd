...
While looking online and researching RSPCA we came across many articles that were indirectly blaming RSPCA for their high euthanize rates and some individuals who saw the worst side of RSPCA. That got us interested in the outcomes from RSPCA and as RSPCA operates state wise. After a while, it raised a question about which animal is euthanized most. @powell_2020

We also came across multiple articles and web pages dedicated to the adoption of animals that have been in the care of RSPCA. We wanted to know which state rehomes the most animals. If you are interested please click this @Adopt_A_Pet
...
```{r plot4, fig.width = 8, fig.height = 8, fig.cap="Reclaimed animals: Timeline", fig.align= "center"}
